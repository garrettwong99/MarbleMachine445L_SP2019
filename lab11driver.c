...
//File path
//C:\Users\garre\Documents\Garrett\Academics\y3spring\EE445L\ValvanoWareTM4C123v5

#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "inc/tm4c123gh6pm.h"
#include "../ValvanoWareTM4C123v5/inc/ST7735.h"
#include "../ValvanoWareTM4C123v5/inc/PLL.h"
#include "../ValvanoWareTM4C123v5/lab11/Timer2.h"
#include "../ValvanoWareTM4C123v5/lab11/Timer3.h"
#include "../ValvanoWareTM4C123v5/lab11/UART.h"
#include "../ValvanoWareTM4C123v5/lab11/PortF.h"
#include "../ValvanoWareTM4C123v5/lab11/esp8266.h"
#include "ServoDriver.h"
#include "../ValvanoWareTM4C123v5/lab11/iodriver.h"
...
// -------------------------------PINS and #Defines used for DEBUGGING------------
uint32_t LED;      // VP1 
uint32_t LastF;    // VP74
int acc_data = 0;
extern int servoxdeg;
extern int servoydeg;
...
int main(void){       
  ...
  PWM0G_Init(25000,1725); // initializes the PWM
	//IO_Init(); // initalizes test buttons
  ...
  while(1) {   
    WaitForInterrupt();
		...
		//printf("servo x : %d /n", servoxdeg);
		//printf("servo y : %d", servoydeg);
